...
class MiniJavaTokensTest {
  ...
  private static Color colourOf(HighlightRegion region) {
  ...
  void regexHighlighterRemovesKeywordInsideLineCommentAfterConflictResolution() {
    ...
    assertEquals(MiniJavaColours.LINE_COMMENT_COLOUR, colourOf(regions.get(0)));
  }

  @Test
  void regexHighlighterKeepsJavadocInsteadOfNormalBlockComment() {
    String text = "/** public class Test */";
    ...
    assertEquals(MiniJavaColours.JAVADOC_COMMENT_COLOUR, colourOf(regions.get(0)));
  }
